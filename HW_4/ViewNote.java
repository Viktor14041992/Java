...
public class ViewNote {
    ...
    private void update() throws Exception {
        ...
        String fieldName = prompt("Какое поле: ");
    ...
    private void create() throws Exception {
        ...
        String dayOfEntry = prompt("Дата ввода: ");
        String timeOfEntry = prompt("Время ввода: ");
        String deadline = prompt("Дедлайн: ");
        String authorsFIO = prompt("ФИО автора: ");

        Note note = new Note(head, dayOfEntry, timeOfEntry, deadline, authorsFIO);
